...
class FilterBudgetToggleWidget extends StatelessWidget {
  ...
  void updateFilter(FilterExpense filterExpense) {
    summaryController.settingsUseCase.put(selectedFilterExpenseKey, filterExpense);
    summaryController.filterExpenseNotifier.value = filterExpense;
  }

  void updateIncludeTransfer(bool value) {
    summaryController.settingsUseCase.put(includeTransferExpense, value);
    summaryController.includeTransferNotifier.value = value;
  }
    ...
    return ValueListenableBuilder<FilterExpense>(
      ...
      builder: (_, value, child) {
        return ValueListenableBuilder<bool>(
            ...
            builder: (_, includeTransfer, child) {
              return SafeArea(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SwitchListTile(
                        title: const Text("Include transfer expenses"),
                        value: includeTransfer,
                        onChanged: (value) {
                          updateIncludeTransfer(value);
                        },
                      ),
                    ),
                  ],
